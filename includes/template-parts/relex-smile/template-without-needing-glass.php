...
<section class="section overflow-x-hidden sm:overflow-x-visible md:px-8">
    ...
    >
        <div class="bg-[#E5FAFF] px-[4.4rem] py-16 md:mt-32 md:px-[11rem] md:py-[13rem]">
            ...
            >
                Say hello to clear vision with ReLEX SMILE Laser Eye Surgery!
            </h3>
        ...
        <div class="ml-0 w-full px-8 md:px-0">
            ...
            >
                <img
                    ...
                    src="<?php echo MY_ICLINIC_PATH_URL . 'assets/images/feature/man-laughing-with-lagedge.png'; ?>"
                />

                <img
                    class="h-full max-h-[23.8rem] w-full object-cover md:hidden md:max-h-max"
                    src="<?php echo MY_ICLINIC_PATH_URL .
                        'assets/images/feature/man-laughing-with-lagedge-mobile.png'; ?>"
                />
            </div>
        </div>
    </div>
