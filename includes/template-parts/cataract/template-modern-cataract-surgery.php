<section class="section px-8">
    ...
    >
        ...
        >
            <div>
                <?php getSVG('assets/images/feature/eye-testing-letters.svg', 'documents-download-form__feature-image'); ?>
            </div>
            ...
            <ul class="mt-12 flex w-full flex-col items-start justify-start gap-[1.5rem] pb-12 pl-[7.5rem]">
                <li class="flex items-start justify-start gap-4">
                    <?php getSVG('assets/images/icons/icon-check-grey.svg', 'cataract-vision-free-cards-icon mt-[0.4rem]'); ?>
