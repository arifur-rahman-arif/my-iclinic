	...
	<div class="footer__container">
		...
		<div class="footer__body">
			...
			<div class="footer__link-wrapper">
				...
				<ul class="footer__link-list">
					<li class="footer__list"><?php getSVG('assets/images/icons/icon-main-blue.svg')?><span>Info@my-iclinic.co.uk</span></li>
					<li class="footer__list"><?php getSVG('assets/images/icons/icon-phone-blue.svg')?><span>(+44)0208 445 8877</span></li>
					<li class="footer__list"><?php getSVG('assets/images/icons/icon-location-blue.svg')?><span>960 High Rd, London N12
							9RY</span></li>
				</ul>
			</div>
		</div>
